...
export const en: Content = {
  ...
  console: {
    banner: [
      { kind: 'head', text: 'Nikolay Ivakhnenko — C# / .NET developer' },
      { kind: 'dim', text: 'Rostov-on-Don · 22 · Java developer at Sberbank' },
      { kind: 'out', text: ' ' },
      { kind: 'out', text: "This is the site's file system: directories, files and everything that did not fit on the map." },
      { kind: 'dim', text: 'help lists the commands, ls shows what is next to you.' },
    ],
