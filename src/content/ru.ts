...
export const ru: Content = {
  ...
  console: {
    banner: [
      { kind: 'head', text: 'Ивахненко Николай — C# / .NET-разработчик' },
      { kind: 'dim', text: 'Ростов-на-Дону · 22 года · Java-разработчик в ПАО Сбербанк' },
      { kind: 'out', text: ' ' },
      { kind: 'out', text: 'Это файловая система сайта: каталоги, файлы и всё, что не поместилось на карту.' },
      { kind: 'dim', text: 'help — список команд, ls — что лежит рядом.' },
    ],
